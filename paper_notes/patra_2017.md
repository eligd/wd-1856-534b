...
- Under orbital decay model, can constrain $Q_*$ from $dP/dt$, $M_p/M_*$, and $R_*/a$
- Under apsidal precession model, can constrain Love numper $k_p$ (which describes how centrally concentrated the planet's mass is) from $d\omega/dE$, $M_*/M_p$, and $R_p/a$